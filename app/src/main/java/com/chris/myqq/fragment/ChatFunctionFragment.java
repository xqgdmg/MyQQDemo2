...
public class ChatFunctionFragment extends BaseFragment2 {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        TextView tvAlbum = (TextView) rootView.findViewById(R.id.chat_function_photo);
        TextView tvCamera = (TextView) rootView.findViewById(R.id.chat_function_photograph);

        tvCamera.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (ContextCompat.checkSelfPermission(getActivity(),Manifest.permission.CAMERA) != PackageManager.PERMISSION_GRANTED) {
                    ActivityCompat.requestPermissions(getActivity(),new String[]{Manifest.permission.CAMERA},MY_PERMISSIONS_REQUEST_CALL_PHONE);
                } else {
                    takePhoto();
                }
            }
